...
%SystemRoot%\system32\setx WIND_LAYER_PATHS %INPUTLAYER% 
...
set SRC_BSP=%INPUTBSP%;%PWD%BRANSON_BSP\BSP_5728_SR2107
echo Your Current BRANSON_BSP Path: %SRC_BSP%

:: Set Path variable
%SystemRoot%\system32\setx WIND_BSP_PATHS %SRC_BSP% 
:: Set Path variable
