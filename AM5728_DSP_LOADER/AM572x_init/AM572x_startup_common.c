...
void AM572x_target_connect_sequence();
//menuitem "AM572x Misc Module configurations"

int silicon_type;

void AM57xx_EVM_Initialization(int EVM)
{
...
void Watchdog_disable(int print_off)
{
    if (print_off == 0)
    {
        if (DEBUG_PRINT)
 ...
 *****************************************************************************/
#if 0
 void Configure_I2C_Controller_Module()
 {
    if(DEBUG_PRINT)
 ...
 *****************************************************************************/
void Set_PMIC_Value(int reg, int Val)
{
