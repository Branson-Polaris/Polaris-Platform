...
#define LOGFILE1 					MMC_EMMC_DEV_NAME PATH_SEPARATOR 	"logFile1.txt" /* Path to store the logfile1 */
#define LOGFILE2 					MMC_EMMC_DEV_NAME PATH_SEPARATOR 	"logFile2.txt" /* Path to store the logfile2 */
