...
#define P1_BASE_DB_FILE_PATH_ROMFS 		ROMFS_DEV_NAME PATH_SEPARATOR P1_BASE_DB_FILE_NAME

#ifdef ROM_FS

#define DKM_TEST_PATH 	"/sd0:1/BransonDrv_DKM_Test.out"

#define ENI_PATH	 						"/romfs/SC_PC_AC_L1A.xml"
#define SC_RTP_PATH							"/romfs/RTP_ASC.vxe"
