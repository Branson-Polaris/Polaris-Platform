...
*
******************************************************************************/
int SQLiteDB::EstablishDataBaseConnection(std::string strDBPath)
{
...
*
******************************************************************************/
std::string SQLiteDB::ExecuteQuery(std::string strSqlStatement, int *pnStatus, int nRetryCounter)
{
...
*
******************************************************************************/
std::string SQLiteDB::GetDBColumnNames(std::string strTableName, int *pnStatus)
{
	int nErrCode = SQLITE_ERROR, ncolumnCount = 0;
	std::string strColumnHeaderBuf = "";
	sqlite3_stmt* ptrSqlStmt = nullptr;
	std::string strSqlStatement = "SELECT * FROM " + strTableName + " WHERE 0=1;";
...
*
******************************************************************************/
int SQLiteDB::GetDBColumnCount(std::string strTableName, int *pnStatus)
{
	int nErrCode = SQLITE_ERROR, nColumnCount = 0;
	sqlite3_stmt* ptrSqlStmt = nullptr;
	std::string strSqlStatement = "SELECT * FROM " + strTableName + " WHERE 0=1;";
...
*
******************************************************************************/
int SQLiteDB::GetNumberOfRows(std::string strTableName, int *pnStatus, int nRetryCounter)
{
	int nErrCode = SQLITE_ERROR, nRowCount = -1;

	std::string strQuery = "SELECT COUNT(1) FROM " + strTableName + ";";
...
*
******************************************************************************/
int SQLiteDB::GetMinRowID(std::string strTableName, int *pnStatus, int nRetryCounter)
{	
...
*
******************************************************************************/
int SQLiteDB::DeleteOneTableRow(std::string strTableName, int nRowID, int nRetryCounter)
{
	std::string strQuery = "DELETE FROM " + strTableName + " WHERE ROWID=" + std::to_string(nRowID) + ";";
...
*
******************************************************************************/
int SQLiteDB::DeleteMultipleTableRows(std::string strTableName, int nMinRowID, int nMaxRowID, int nRetryCounter)
{
	std::string strQuery = "DELETE FROM " + strTableName + " WHERE ROWID BETWEEN " + std::to_string(nMinRowID) + " AND " + std::to_string(nMaxRowID) +";";
...
*
******************************************************************************/
int SQLiteDB::DeleteAllTableRows(std::string strTableName, int nRetryCounter)
{
	std::string strQuery = "DELETE FROM " + strTableName + ";";
...
*
******************************************************************************/
int SQLiteDB::getMinMaxRowID(std::string strTableName, bool bIsMinRowIDRequest, int *pnStatus, int nRetryCounter)
{
