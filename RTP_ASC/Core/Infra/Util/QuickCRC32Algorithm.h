...
***************************************************************************/
#ifndef QUICKCRC32ALGORITHM_H
#define QUICKCRC32ALGORITHM_H
#include <vxworks.h>

#define  CRC_8BIT_SHIFT         8
#define  CRC_24BIT_SHIFT        24
...
class QuickCRC32Algorithm
{
public:
    QuickCRC32Algorithm();
    static UINT32 crc32_ccitt(const void *buf, UINT32 len);
};

#endif // QUICKCRC32ALGORITHM_H
