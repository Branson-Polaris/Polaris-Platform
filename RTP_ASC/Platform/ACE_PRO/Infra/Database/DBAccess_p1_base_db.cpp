...
*
******************************************************************************/
std::string DBAccessP1BaseDB::GetWeldResultCSVParameters(int nRowID,  int *pnStatus, int nRetryCounter)
{
	std::string strQuery = "SELECT " + strP1BaseWeldResultCSVParamString + " FROM " + TABLE_WELD_RESULT + " WHERE ROWID=" + std::to_string(nRowID) + ";";
...
*
******************************************************************************/
std::string DBAccessP1BaseDB::GetWeldResultCSVReportHeader()
{
...
*
******************************************************************************/
std::string DBAccessP1BaseDB::GetWeldSignatureCSVParameters(int nRowID, int &nBlobParamNumber, int *pnStatus, int nRetryCounter)
{
	std::string strQuery = "SELECT " + strP1BaseWeldSignatureCSVParamString + " FROM " + TABLE_WELD_SIGNATURE + " WHERE ROWID=" + std::to_string(nRowID) + ";";
...
*
******************************************************************************/
std::string DBAccessP1BaseDB::GetWeldSignatureCSVReportHeader1()
{
...
*
******************************************************************************/
std::string DBAccessP1BaseDB::GetWeldSignatureCSVReportHeader2()
{
