...
{  
	...
	case LAST_WELD_RESULT_DATA_WRITE:
		...
		printf("LAST_WELD_RESULT_DATA_WRITE recived in data write datarequestBuffer[0]=%d,datarequestBuffer[0]=%d,\n",datarequestBuffer[0],datarequestBuffer[1]);
		break;
	...
	default:
		...
		logger::add_entry(static_log_id ,SEVERITY::LOG_GENERAL_INFO, (uint8_t*)msg, sizeof(msg));
		break;     
...
{   
	...
	else
	{
		...
		logger::add_entry(static_log_id,SEVERITY::LOG_ALARM , (uint8_t*)msg, sizeof(msg));
	}
